...
public abstract class DateUtils
{
    ...
    public static String addMonthsToDateStr(String dateStr, int amount)
    {
    ...
    {
        logger.info(getFirstDayOfThisMouth());
        logger.info(addMonthsToDateStr(getFirstDayOfThisMouth(), 1));
    }
}
